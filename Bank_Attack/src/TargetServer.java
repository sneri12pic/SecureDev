...
public class TargetServer {
	...
	public TargetServer(Console terminalHandle) throws Exception {
		...
		// instantiate servlet on port 15000
		server = new Server(new InetSocketAddress("localhost", 15000));
		...
		context.addServlet(AdminPasswordResetServlet.class, "/admin-reset");
	}
	...
	public boolean startServer() {
		...
		term.printf("Open a web browser and access 'localhost:15000/welcome' to view the web interface.\n");
		do {
